...
import { s as Route$4, A as ARTICLES, P as PageShell, t as heroImg, H as HOME_SLIDES_ENDPOINT, u as extractSlideImageUrls, v as extractLargestSrcsetUrl, w as normalizeImageUrl } from "./router-DoZbT7Lo.mjs";
...
const FAQS = [{
  ...
  a: "BYD จินหลง มอเตอร์ รังสิต เป็นตัวแทนจำหน่ายอย่างเป็นทางการ ให้บริการครบวงจรทั้งการขาย ทดลองขับ บริการหลังการขาย พร้อมโปรโมชั่นพิเศษเฉพาะลูกค้าของเรา"
}];
const SEO_HUB = [{
  title: "BYD จินหลง มอเตอร์ รังสิต",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-x-clip", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-[92vh] flex items-center overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-2xl text-lg text-white sm:text-xl", children: "โชว์รูมและศูนย์บริการมาตรฐาน BYD สาขา รังสิต" }),
