...
import { P as PageShell } from "./router-DoZbT7Lo.mjs";
import { T as TestDriveForm } from "./TestDriveForm-B_JZX53b.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImg, alt: "ทดลองขับ BYD ที่โชว์รูม BYD จินหลง รังสิต", width: 1920, height: 1080, className: "h-full w-full object-cover" }),
