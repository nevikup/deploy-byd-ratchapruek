...
import { R as Route$a, P as PageShell } from "./router-DoZbT7Lo.mjs";
...
function InstallmentPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl px-4 space-y-4 text-muted-foreground leading-relaxed", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "BYD จินหลง รังสิต ร่วมมือกับสถาบันการเงินชั้นนำเพื่อมอบโปรโมชั่นดอกเบี้ยพิเศษ เริ่มต้นที่ 0% สูงสุด 48 งวด สำหรับลูกค้าที่จองภายในระยะเวลาแคมเปญ" })
    ] }) }),
