...
import { a as SLUG$8, P as PageShell } from "./router-4Wq99WH9.mjs";
...
import { a as getModel, c as calcInstallment, f as formatBaht, d as colorWhite$1 } from "./models-0Rvkj58o.mjs";
...
const brochureContentImage = "/assets/byd-seal-5-dm-i-content-desktop-B_m05HJ7.webp";
const bladeBatteryImage = "/assets/battery-blade-DnoVyE-_.webp";
const efficiencyStoryImage = "/assets/sealion5-description-2-CpIlN3UT.png";
const exterior1 = "/assets/exterior-1-Cz4eQmQx.png";
const exterior2 = "/assets/exterior-2-rPZOZex9.webp";
const exterior3 = "/assets/exterior-3-nugb7qIU.png";
const exterior4 = "/assets/exterior-4-CNiot3CL.png";
const exterior5 = "/assets/exterior-5-CoBoYqEx.webp";
const exterior6 = "/assets/exterior-6-3PMFLVwp.png";
const interior1 = "/assets/interior-1-CcZtEE7-.webp";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative w-full min-h-[88vh] flex items-end overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full px-6 sm:px-12 lg:px-20 pb-16 pt-32", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          { label: "ระยะทางวิ่งไฟฟ้าล้วน", val: "110 km" },
          { label: "0-100 กม./ชม.", val: "8.5 sec" },
          { label: "กำลังรวม", val: "155 kW" },
          { label: "แรงบิดสูงสุด", val: "210 Nm" },
          { label: "แบตเตอรี่", val: "18.3 kWh" }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 border-y border-border bg-surface/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: "เลือกรุ่นย่อย" })
      ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-3xl p-6 sm:p-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4", children: [
          ...
          { label: "0-100 กม./ชม.", val: `${currentTrim.accel} sec` },
          { label: "ระยะทางวิ่งไฟฟ้าล้วน", val: `${currentTrim.evRange} km` },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-y border-border py-16 sm:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-16 sm:space-y-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: bladeBatteryImage, alt: "BYD Blade Battery", className: "w-full object-cover", style: { maxHeight: "620px" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 max-w-3xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-black leading-tight", children: "BYD BLADE BATTERY" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground leading-relaxed", children: "นวัตกรรมใหม่ของเทคโนโลยีแบตเตอรี่ เอกสิทธิ์เฉพาะของ BYD ให้ความปลอดภัย และความทนทาน ด้วยการจัดวางเซลล์แบบพิเศษ มอบความมั่นใจในทุกการเดินทาง และรองรับการใช้งานในชีวิตประจำวันได้อย่างเต็มประสิทธิภาพ" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: efficiencyStoryImage, alt: "Shine in Efficiency", className: "w-full object-cover", style: { maxHeight: "620px" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 max-w-3xl space-y-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-black leading-tight", children: "Shine in Efficiency" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground leading-relaxed", children: "เทคโนโลยี BYD DM-i มอบความประหยัดที่ให้คุณไปได้ไกลกว่า โดยสามารถเดินทางได้ไกลถึง 1,200 กิโลเมตร และเดินทางด้วยไฟฟ้า 100% ได้ไกลสูงสุดถึง 110 กม. (NEDC)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-black leading-tight", children: "BYD DM-i" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground leading-relaxed", children: "ขับเคลื่อนด้วยมอเตอร์ไฟฟ้ากำลังสูง ผสานเครื่องยนต์ขนาด 1.5 ลิตร 4 สูบ ที่ออกแบบมาเพื่อรถยนต์ปลั๊กอินไฮบริดโดยเฉพาะ และ BYD Blade Battery ความปลอดภัยสูง เอกสิทธิ์เฉพาะจาก BYD" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: brochureContentImage, alt: "BYD SEALION 5 DM-i", className: "w-full object-cover" }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "ขนาดและมิติ", icon: Ruler, rows: dimensionsRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "ระบบส่งกำลัง", icon: Zap, rows: drivetrainRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "สมรรถนะ", icon: Gauge, rows: performanceRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "ระบบการชาร์จ", icon: Battery, rows: chargingRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "ช่วงล่างและเบรก", icon: Weight, rows: chassisRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "มัลติมีเดียและความสะดวกสบาย", icon: Zap, rows: multimediaRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "ระบบความปลอดภัย", icon: ShieldCheck, rows: safetyRows }) })
      ] })
    ] }) }),
