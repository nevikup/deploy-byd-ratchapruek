...
import { f as fallbackModel, P as PageShell, h as heroBanner$3 } from "./router-Dr8CBzL6.mjs";
...
import { g as getInstallmentModel, c as calcInstallment, f as formatBaht } from "./models-5WlIsOUj.mjs";
...
const EXTERIOR_GALLERY = [
  { img: extendedExterior1, label: "กระจกมองข้าง รุ่น EXTENDED", desc: "กระจกมองข้างพร้อม NFC Card Key เพื่อการเข้าใช้งานที่สะดวก" },
  { img: extendedExterior2, label: "ดีไซน์ด้านท้าย รุ่น EXTENDED", desc: "ไฟท้าย LED แบบพาดยาว เติมมิติให้ด้านท้ายของรถ" },
  { img: extendedExterior3, label: "ไฟหน้าและกันชน รุ่น EXTENDED", desc: "เส้นสายด้านหน้าที่โฉบเฉี่ยว พร้อมรายละเอียดการออกแบบที่โดดเด่น" },
  { img: extendedExterior4, label: "ดีไซน์ด้านหน้า รุ่น EXTENDED", desc: "รูปลักษณ์ด้านหน้าที่ลงตัว พร้อมเอกลักษณ์ BYD" },
  { img: extendedExterior5, label: "พื้นที่เก็บสัมภาระ รุ่น EXTENDED", desc: "ห้องเก็บสัมภาระด้านท้าย รองรับการใช้งานในทุกวัน" },
  { img: extendedExterior6, label: "พอร์ตชาร์จ รุ่น EXTENDED", desc: "พอร์ตชาร์จสำหรับการเติมพลังงานอย่างสะดวก" },
...
const EXTENDED_FEATURES = [
  "แบตเตอรี่เพิ่มเป็น 26.6 kWh",
  "ระยะทาง EV ตามมาตรฐาน NEDC เพิ่มเป็น 150 กม.",
  "DC Fast Charging เพิ่มเป็น 55 kW",
  "เพิ่ม Power Side Mirror พร้อม Memory Function",
  "กระจกมองหลังปรับลดแสงอัตโนมัติ",
  "หน้าจอกลาง 15.6 นิ้ว แบบไม่หมุน",
  "เพิ่ม Head-up Display (W-HUD)",
  "เบาะคนขับปรับไฟฟ้า 8 ทิศทาง",
  "เพิ่มระบบระบายอากาศเบาะคนขับ",
  "เพิ่มระบบจดจำตำแหน่งเบาะคนขับ",
  "Ambient Light แบบ RGB Dynamic Mood Lights",
  "เครื่องเสียง DYNAUDIO 10 ลำโพง",
  "บันไดข้างประตูแบบ Metal Welcome Step",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-6 py-4 border-b border-border bg-background/40", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold", children: "BYD SEALION 6 DM-I รุ่น Extended" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "grid gap-x-8 gap-y-3 px-6 py-5 text-sm text-foreground/90 sm:grid-cols-2 sm:px-8 sm:py-6", children: EXTENDED_FEATURES.map((feature) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 leading-relaxed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "mt-0.5 h-4 w-4 shrink-0 text-primary", "aria-hidden": true }),
