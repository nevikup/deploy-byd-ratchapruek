...
import { f as fallbackModel, P as PageShell, h as heroBanner$3 } from "./router-Bna36lkW.mjs";
...
import { g as getInstallmentModel, c as calcInstallment, f as formatBaht } from "./models-CGoesGQ4.mjs";
...
function BydSealion6DmiBrochure({ model }) {
  ...
  const faqs = [
    { q: "BYD SEALION 6 DM-i ราคาเท่าไร?", a: "Dynamic 899,900 บาท · Premium 999,900 บาท พร้อมโปรโมชันล่าสุดจากทีมที่ปรึกษา" },
