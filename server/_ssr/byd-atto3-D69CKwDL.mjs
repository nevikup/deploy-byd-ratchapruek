...
import { n as SLUG$2, P as PageShell, m as heroBanner$2 } from "./router-Bna36lkW.mjs";
...
import { a as getModel, c as calcInstallment, f as formatBaht, l as colorWhite$4 } from "./models-CGoesGQ4.mjs";
...
const TRIMS = [
  { key: "premium", name: "Premium", price: 799900, accel: "7.9", range: "410", battery: "50.25 kWh", power: "150 kW", torque: "310 Nm" },
...
function BydAtto3Brochure({ model }) {
  ...
  const faqs = [
    { q: "BYD ATTO 3 ราคาเท่าไร?", a: "Premium ฿799,900 · Extended ฿849,900 ทีมงานพร้อมแจ้งโปรโมชั่นล่าสุดทุกรุ่น" },
