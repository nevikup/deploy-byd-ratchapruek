...
import { s as Route$4, A as ARTICLES, P as PageShell, t as heroImg, H as HOME_SLIDES_ENDPOINT, u as extractSlideImageUrls, v as extractLargestSrcsetUrl, w as normalizeImageUrl } from "./router-Bna36lkW.mjs";
...
const ModelsScroller = reactExports.lazy(() => import("./ModelsScroller-BQq2cVMF.mjs").then((module) => ({
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-x-clip", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHead, { eyebrow: "รถยนต์ทุกรุ่น", eyebrowClassName: "bg-primary/10 text-primary", title: "รถทุกรุ่น", subtitle: "เลือกรุ่นที่ใช่สำหรับคุณ จาก Hatchback, Sedan, SUV และ Plug-in Hybrid หลากหลายสไตล์" }),
