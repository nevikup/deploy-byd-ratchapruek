...
import { g as SLUG$5, P as PageShell, e as heroBanner } from "./router-4Wq99WH9.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, i as colorWhite$3 } from "./models-0Rvkj58o.mjs";
...
const imgEPlatform = "/assets/e-platform3-CptEevNM.webp";
const imgGlassRoof = "/assets/glassRoof-B_xvyvm_.webp";
const imgSilver = "/assets/silver-platform-C-x1Epon.webp";
const extSurge = "/assets/surge-BOo3dMJS.webp";
const extCrystalLed = "/assets/crystalLed-CR650-_4.webp";
const extLedTail = "/assets/ledTailLight-D9ZMGgAS.webp";
const extWheels = "/assets/wheels-hAojzZRL.webp";
const intDesign = "/assets/dolphinDesign-BKa0DB6D.webp";
const intDriveMode = "/assets/driveMode-Dv4Ph9Oq.webp";
const intCharging = "/assets/wirelessCharging-055Noeyw.webp";
const TRIMS = [
...
const EXTERIOR_GALLERY = [
  { img: extSurge, label: "ดีไซน์ Fluid Surge", desc: "เส้นสายตัวถังที่พลิ้วไหวและโดดเด่น ได้แรงบันดาลใจจากคลื่นมหาสมุทร" },
  { img: extCrystalLed, label: "ไฟหน้า Crystal LED", desc: "ชุดไฟหน้า LED ดีไซน์ผลึกอันเป็นเอกลักษณ์" },
  { img: extLedTail, label: "ไฟท้าย LED", desc: "ไฟท้าย LED แบบ Sequential สร้างความโดดเด่นจากด้านหลัง" },
  { img: extWheels, label: "ล้ออัลลอย", desc: "ล้ออัลลอยแอโรไดนามิกขนาด 18 และ 19 นิ้ว" }
];
const INTERIOR_GALLERY = [
  { img: imgGlassRoof, label: "หลังคากระจกพาโนรามิกเคลือบเงิน", desc: "หลังคากระจกพาโนรามิกขนาด 1.9 ตร.ม. พร้อมสารเคลือบป้องกันรังสี UV" },
  { img: intDesign, label: "ห้องโดยสาร Ocean Aesthetics", desc: "แผงคอนโซลที่ได้แรงบันดาลใจจากห้องนักบิน พร้อมวัสดุระดับพรีเมียม" },
  { img: intDriveMode, label: "ระบบอัจฉริยะ DiLink", desc: "หน้าจอสัมผัสแบบหมุนได้ขนาด 15.6 นิ้ว พร้อมระบบควบคุมอัจฉริยะ" },
  { img: intCharging, label: "แท่นชาร์จไร้สายคู่", desc: "แท่นชาร์จไร้สาย 2 จุด เพื่อการเชื่อมต่อที่สะดวกไร้รอยต่อ" }
];
const DIMENSIONS = [
...
function BydSealBrochure({ model }) {
  ...
  const faqs = [
    {
      q: "BYD SEAL ราคาเท่าไร?",
      a: "Dynamic RWD ฿1,325,000 · Premium RWD ฿1,449,000 · AWD Performance ฿1,599,000 ทีมงานพร้อมแจ้งโปรโมชั่นล่าสุดทุกรุ่น"
    },
    {
      q: "BYD SEAL วิ่งได้ไกลกี่กิโลเมตร?",
      a: "Dynamic RWD 510 กม. · Premium RWD 650 กม. · AWD Performance 580 กม. (NEDC Combined Cycle)"
    },
    {
      q: "BYD SEAL เร่ง 0-100 ได้กี่วินาที?",
      a: "Dynamic 7.5 วิ · Premium 5.9 วิ · AWD Performance 3.8 วิ พร้อมแรงบิดสูงสุด 670 Nm"
    },
    {
      q: "ระบบชาร์จเป็นอย่างไร?",
      a: "รองรับ AC Type 2 (7 kW) และ DC CCS2 สูงสุด 150 kW (รุ่น Premium/AWD) พร้อม V2L"
    },
    {
      q: `ผ่อน BYD SEAL เดือนละเท่าไร?`,
      a: `ค่างวดเริ่มต้น ${formatBaht(r.monthly)}/เดือน (ดาวน์ 20% ผ่อน 60 งวด ดอกเบี้ย 2.49%)`
    }
  ];
  const vehicleSchema = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative w-full bg-black overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", style: { maxHeight: "80vh", aspectRatio: "16/9" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, src: "https://www.reverautomotive.com/videos/model/seal/seal-video.mp4", poster: heroBanner, controls: videoPlaying, playsInline: true, className: "w-full h-full object-cover", onPlay: () => setVideoPlaying(true), style: { display: "block" } }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-y border-border overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: imgEPlatform, imgAlt: "e-Platform 3.0", reverse: true, title: "e-PLATFORM 3.0", subtitle: "Next-Gen EV Architecture", body: "ยกระดับการขับขี่สู่อนาคตด้วยนวัตกรรมแพลตฟอร์มที่พัฒนาขึ้นเพื่อรถยนต์พลังงานไฟฟ้าโดยเฉพาะ ด้วยเทคโนโลยี CTB (Cell-to-Body) ที่จัดวางแบตเตอรี่และอุปกรณ์โดยคำนึงถึงความแข็งแรงและปลอดภัย" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: imgGlassRoof, imgAlt: "Silver-Plated Panoramic Glass Roof", reverse: false, title: "Silver-Plated Panoramic Glass Roof", subtitle: "Premium Experience", body: "หลังคากระจกพาโนรามิก 2 ชั้น ขนาดใหญ่ถึง 1.9 ตารางเมตร ให้มุมมองที่กว้างกว่า พร้อมการเคลือบด้วย Silver-plated ที่ช่วยลดปริมาณแสงที่ผ่านเข้ามาในห้องโดยสาร พร้อมป้องกัน UV" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: imgSilver, imgAlt: "Chassis Platform", reverse: true, title: "Precision Chassis", subtitle: "การควบคุมและสมรรถนะการขับขี่", body: "ช่วงล่างด้านหน้าแบบ Double Wishbone และช่วงล่างด้านหลังแบบ Multi-Link มอบความนุ่มนวลในการขับขี่และการควบคุมที่ยอดเยี่ยม รุ่น AWD Performance เพิ่มระบบปรับความหนืด FSD เพื่อความสมดุลสูงสุดในการขับขี่" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
