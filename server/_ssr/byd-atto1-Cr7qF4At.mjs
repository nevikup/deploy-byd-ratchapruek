...
import { p as SLUG, P as PageShell } from "./router-4Wq99WH9.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, o as colorShellWhite } from "./models-0Rvkj58o.mjs";
...
const storyImage2 = "/assets/atto1-description-2-wgNAOfCR.webp";
const exteriorBodyDesign = "/assets/exterior-bodyDesign-BlHQumVj.webp";
const exteriorHeadLight = "/assets/exterior-headLight-vuYZeq10.webp";
const exteriorAllowWheel = "/assets/exterior-allowWheel-D2RRuIqb.webp";
const exteriorDigitalKey = "/assets/exterior-digitalKey-CRklPh8m.webp";
const exteriorCharging = "/assets/exterior-charging-D4F-FxtD.webp";
const exteriorSpoiler = "/assets/exterior-spoiler-CcIhQAC4.webp";
const interiorConsoleDesign = "/assets/interior-consoleDesign-Dm77uHSW.webp";
const interiorMultimediaScreen = "/assets/interior-multimediaScreen-C7F_QdbU.webp";
const interiorWirelessCharger = "/assets/interior-wirelessCharger-uzT4_A7b.webp";
const interiorRearPassengerSpace = "/assets/interior-rearPassengerSpace-CXlgJwO2.webp";
const interiorDriverSeat = "/assets/interior-driverSeat-BT9iIiQV.webp";
const interiorEasyControl = "/assets/interior-easyControl-CF354hYQ.webp";
const interiorLuggageCapacity = "/assets/interior-luggageCapacity-BSteJutr.webp";
const interiorSteeringAdjustment = "/assets/interior-steeringAdjustment-Q-pDmF2A.webp";
...
const COLORS = [
  { name: "Pop Green", hex: "#d8d762", border: "#d8d762", img: colorPopGreen, note: "Dynamic · Premium" },
  ...
  { name: "Velocity Blue", hex: "#556e8d", border: "#556e8d", img: colorVelocityBlue, note: "Dynamic · Premium" }
];
const EXTERIOR_GALLERY = [
  ...
  { img: exteriorCharging, label: "Charging Port", desc: "ช่องชาร์จไฟฟ้าออกแบบให้ใช้งานง่ายและปลอดภัย" },
  { img: exteriorSpoiler, label: "Rear Spoiler", desc: "สปอยเลอร์ท้ายดีไซน์สปอร์ตเพิ่มความโฉบเฉี่ยว" }
];
const INTERIOR_GALLERY = [
  ...
  { img: interiorDriverSeat, label: "Driver Seat", desc: "เบาะคนขับออกแบบเพื่อความสบายตลอดการเดินทาง" },
  { img: interiorEasyControl, label: "Easy Control Switches", desc: "ปุ่มควบคุมที่เข้าถึงง่าย ใช้งานสะดวกทุกฟังก์ชัน" },
  { img: interiorLuggageCapacity, label: "Luggage Capacity", desc: "พื้นที่เก็บสัมภาระกว้างขวางรองรับการใช้งานทุกวัน" },
  { img: interiorSteeringAdjustment, label: "Steering Adjustment", desc: "พวงมาลัยปรับระดับได้เพื่อท่านั่งขับที่เหมาะกับทุกคน" }
];
const DIMENSIONS = [
...
function BydAtto1Brochure({ model }) {
  ...
  const suspensionRows = SUSPENSION_BRAKE;
  const wheelsRows = WHEELS_TIRES;
  const exteriorRows = EXTERIOR_STD;
  const interiorRows = INTERIOR_STD;
  const multimediaRows = MULTIMEDIA;
  const safetyRows = SAFETY;
  const exteriorColorRows = EXTERIOR_COLOR;
  const interiorColorRows = INTERIOR_COLOR;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ระบบส่งกำลังและสมรรถนะ", icon: Gauge, rows: performanceRows, leftHeader: "Dynamic", rightHeader: "Premium" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ระบบกันสะเทือนและระบบเบรก", icon: Zap, rows: suspensionRows, leftHeader: "Dynamic", rightHeader: "Premium" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ล้อและยาง", icon: Users, rows: wheelsRows, leftHeader: "Dynamic", rightHeader: "Premium" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "อุปกรณ์มาตรฐานภายนอก", icon: Sparkles, rows: exteriorRows, leftHeader: "Dynamic", rightHeader: "Premium" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "อุปกรณ์มาตรฐานภายใน", icon: Users, rows: interiorRows, leftHeader: "Dynamic", rightHeader: "Premium" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "สีภายนอก", icon: Sparkles, rows: exteriorColorRows, leftHeader: "Dynamic", rightHeader: "Premium" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "สีภายใน", icon: Users, rows: interiorColorRows, leftHeader: "Dynamic", rightHeader: "Premium" }) })
      ] })
    ] }) }),
