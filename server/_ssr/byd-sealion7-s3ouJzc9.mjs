...
import { S as SLUG$9, P as PageShell } from "./router-Dr8CBzL6.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, b as colorWhite$2 } from "./models-5WlIsOUj.mjs";
import { T as TestDriveForm } from "./TestDriveForm-CiFVS3OV.mjs";
import { InstallmentCalculator } from "./InstallmentCalculator-BRrRV0rG.mjs";
...
const colorQuantumBlack = "/assets/sealion7-black-DIKjA0Lf.webp";
...
const INTERIOR_GALLERY = [
  {
    ...
    desc: "แสดงข้อมูลการขับขี่บนกระจกหน้าอย่างชัดเจน (AWD Ultimate)"
  },
  {
    img: awdUltimateInterior2,
    label: "Panoramic Glass Roof",
    desc: "หลังคากระจกพาโนรามิกเปิดรับมุมมองกว้างตลอดห้องโดยสาร (AWD Ultimate)"
  },
  {
    img: awdUltimateInterior3,
    label: "Blue Ambient Lighting",
    desc: "แสงไฟตกแต่งสีน้ำเงินสร้างบรรยากาศในห้องโดยสาร (AWD Ultimate)"
  },
  {
    img: awdUltimateInterior4,
    label: "Premium Sound & Wireless Charging",
    desc: "ระบบเสียงและแท่นชาร์จไร้สายบนคอนโซลกลาง (AWD Ultimate)"
  },
  {
    img: awdUltimateInterior5,
    label: "Driver-Focused Cockpit",
    desc: "ห้องโดยสารออกแบบโดยเน้นการควบคุมและหน้าจอกลางของผู้ขับขี่ (AWD Ultimate)"
  },
  {
    img: awdUltimateInterior6,
    label: "Center Console",
    desc: "คอนโซลกลางพร้อม Crystal Shifter และปุ่มควบคุม (AWD Ultimate)"
  },
  {
    img: awdUltimateInterior7,
    label: "Front Cabin Comfort",
    desc: "เบาะนั่งและพื้นที่ห้องโดยสารด้านหน้าที่กว้างขวาง (AWD Ultimate)"
  },
  {
    img: awdUltimateInterior8,
    label: "Blue Interior",
    desc: "ตัวเลือกห้องโดยสารสีฟ้าพร้อมเบาะนั่งดีไซน์พรีเมียม (AWD Ultimate)"
  },
  {
    img: interior1,
    label: "Panoramic Glass Roof",
...
const awdUltimateRows = [
  ...
  { label: "ระบบ iTAC (Intelligent Torque Adaptation Control)", value: true },
  { label: "สีภายนอก Solar Red และ Pulse Purple", value: true },
  { label: "ตัวเลือกห้องโดยสารสีฟ้า (Blue Interior)", value: true }
];
const storySections = [
  {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "overflow-hidden border-y border-border bg-surface/40 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: "* สี Shark Grey มีเฉพาะรุ่น AWD Performance · Solar Red และ Pulse Purple มีเฉพาะรุ่น AWD Ultimate" })
      ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass overflow-hidden rounded-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 border-b border-border bg-background/40 px-6 py-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold", children: "เฉพาะรุ่น AWD Ultimate" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/60", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-3 text-center font-medium", children: "AWD Ultimate" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: awdUltimateRows.map((row, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: index % 2 === 0 ? "bg-background/20" : "", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-3 text-foreground/90", children: row.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { value: row.value }) })
            ] }, row.label)) })
          ] }) })
        ] }) })
      ] })
