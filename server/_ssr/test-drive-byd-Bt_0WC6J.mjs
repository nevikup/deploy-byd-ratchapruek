...
import { P as PageShell } from "./router-DemwHWSp.mjs";
import { T as TestDriveForm } from "./TestDriveForm-CajAHBdN.mjs";
import { FAQ } from "./FAQ-KPtl_5Vj.mjs";
import "../_libs/seroval.mjs";
import { C as CalendarCheck, S as ShieldCheck, b as Clock, c as MapPin, d as CarFront, e as Coffee } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImg, alt: "ทดลองขับ BYD ที่โชว์รูม BYD จินหลง ราชพฤกษ์", width: 1920, height: 1080, className: "h-full w-full object-cover" }),
