...
import { j as SLUG$4, P as PageShell } from "./router-Bna36lkW.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, j as crystalWhite } from "./models-CGoesGQ4.mjs";
...
function BydM6Brochure({ model }) {
  ...
  const faqs = [
    { q: "BYD M6 ราคาเท่าไร?", a: "Dynamic ราคา 909,900 บาท และ Extended ราคา 1,009,900 บาท" },
