...
import { c as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-CnDuuMea.mjs";
...
import "node:https";
import "node:http2";
const appCss = "/assets/styles-wnKXIDdD.css";
...
const SITE_URL = "https://bydrangsit.com";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm leading-relaxed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "บีวายดี จินหลง มอเตอร์ สาขารังสิต" }),
          " ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:029971133", className: "hover:text-foreground", children: "02-997-1133" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:0842018833", className: "hover:text-foreground", children: "084-201-8833" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:0901982056", className: "hover:text-foreground", children: "090-198-2056 (ติดต่อฝ่ายบริการ SA)" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:0952043998", className: "hover:text-foreground", children: "095-204-3998 (ติดต่อฝ่ายทะเบียน)" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:0993155853", className: "hover:text-foreground", children: "099-315-5853 (ติดต่อฝ่ายอะไหล่)" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-foreground", children: "93 ถ.รังสิต-นครนายก ต.ประชาธิปัตย์ อ.ธัญบุรี จ.ปทุมธานี" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://www.facebook.com/BYDjinlongRangsit",
                target: "_blank",
                rel: "noreferrer",
                className: "hover:text-foreground",
                children: "bydjinlongrangsit"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://line.me/R/ti/p/@498gsgno",
                target: "_blank",
                rel: "noreferrer",
                className: "hover:text-foreground",
                children: "LINE @498gsgno"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://www.tiktok.com/@bydrangsit",
                target: "_blank",
                rel: "noreferrer",
                className: "hover:text-foreground",
                children: "@bydrangsit"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://www.instagram.com/bydrangsit",
                target: "_blank",
                rel: "noreferrer",
                className: "hover:text-foreground",
                children: "@bydrangsit"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://www.youtube.com/@bydrangsit",
                target: "_blank",
                rel: "noreferrer",
                className: "hover:text-foreground",
                children: "@bydrangsit"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://twitter.com/bydrangsit",
                target: "_blank",
                rel: "noreferrer",
                className: "hover:text-foreground",
                children: "bydrangsit"
...
const GA_MEASUREMENT_ID = "G-K39SDKGHJL";
  ...
  head: () => ({
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        ...
        content: "Q5RnDzoE-r8tVIun2lRIFxEKtENgb4P4GUCZYwqURtU"
      },
      { title: "บีวายดี จินหลง มอเตอร์ สาขารังสิต | โชว์รูมและศูนย์บริการมาตรฐาน BYD บีวายดี จินหลง" },
      ...
      { property: "og:site_name", content: "BYD จินหลง รังสิต" },
...
const $$splitComponentImporter$l = () => import("./test-drive-byd-DLXEyB4z.mjs");
const Route$m = createFileRoute("/test-drive-byd")({
  head: () => ({
    meta: [{
      title: "ทดลองขับ BYD ฟรี | บีวายดี จินหลง มอเตอร์ สาขารังสิต"
    }, {
      name: "description",
      content: "นัดทดลองขับรถ BYD ทุกรุ่นฟรี ที่โชว์รูม BYD จินหลง รังสิต พร้อมทีมที่ปรึกษามืออาชีพ จองออนไลน์ทันที"
    }, {
      property: "og:title",
      content: "ทดลองขับ BYD ฟรี | BYD จินหลง รังสิต"
    }, {
...
const $$splitComponentImporter$k = () => import("./models-B4bM_2ym.mjs");
const Route$k = createFileRoute("/models")({
  pendingMs: 150,
  pendingComponent: ModelsPagePending,
  head: () => ({
    meta: [{
      title: "รถและราคา BYD ทุกรุ่น | บีวายดี จินหลง มอเตอร์ สาขารังสิต"
    }, {
      name: "description",
...
const $$splitComponentImporter$j = () => import("./contact-Bch_NzAr.mjs");
const Route$j = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      title: "ติดต่อเรา | บีวายดี จินหลง มอเตอร์ สาขารังสิต"
    }, {
      name: "description",
      content: "ติดต่อ BYD จินหลง รังสิต พร้อมข้อมูลโชว์รูม BYD กรุงเทพ พื้นที่บริการ เวลาทำการ แผนที่ และช่องทาง LINE/Facebook ครบในหน้าเดียว"
    }, {
      property: "og:title",
      content: "ติดต่อและข้อมูลโชว์รูม | BYD จินหลง รังสิต"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$i = () => import("./byd-sealion7-Y1w0cEZn.mjs");
const model$8 = getModel(SLUG$9);
const Route$i = createFileRoute("/byd-sealion7")({
  head: () => ({
    meta: [{
      title: `${model$8.name} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
    }, {
      name: "description",
      ...
      property: "og:title",
      content: `${model$8.name} | BYD จินหลง รังสิต`
    }, {
      property: "og:description",
...
const $$splitComponentImporter$h = () => import("./byd-sealion6dmi-CA2XMqG_.mjs");
const Route$h = createFileRoute("/byd-sealion6dmi")({
  head: () => {
    const model2 = getInstallmentModel("byd-sealion6-dmi") ?? fallbackModel;
    return {
      meta: [{
        title: `${model2.name} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
      }, {
        name: "description",
...
const $$splitComponentImporter$g = () => import("./byd-sealion5dmi-B4TYPR5g.mjs");
const model$7 = getModel(SLUG$8);
const Route$g = createFileRoute("/byd-sealion5dmi")({
  head: () => ({
    meta: [{
      title: `${model$7.name} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
    }, {
      name: "description",
      ...
      property: "og:title",
      content: `${model$7.name} | BYD จินหลง รังสิต`
    }, {
      property: "og:description",
...
const $$splitComponentImporter$f = () => import("./byd-seal6-BXG97Rts.mjs");
const model$6 = getModel(SLUG$7);
const Route$f = createFileRoute("/byd-seal6")({
  head: () => ({
    meta: [{
      title: `${model$6.name} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
    }, {
      name: "description",
      ...
      property: "og:title",
      content: `${model$6.name} | BYD จินหลง รังสิต`
    }, {
      property: "og:description",
...
const $$splitComponentImporter$e = () => import("./byd-seal5dmi-CgfM3Sh6.mjs");
const model$5 = getInstallmentModel(SLUG$6);
const Route$e = createFileRoute("/byd-seal5dmi")({
  head: () => ({
    meta: [{
      title: `${model$5?.name ?? "BYD SEAL 5 DM-i"} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
    }, {
      name: "description",
      ...
      property: "og:title",
      content: `${model$5?.name ?? "BYD SEAL 5 DM-i"} | BYD จินหลง รังสิต`
    }, {
      property: "og:description",
...
const $$splitComponentImporter$d = () => import("./byd-seal-DyWqDHGP.mjs");
const model$4 = getModel(SLUG$5);
const Route$d = createFileRoute("/byd-seal")({
  head: () => ({
    meta: [{
      title: `${model$4.name} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
    }, {
      name: "description",
      ...
      property: "og:title",
      content: `${model$4.name} | BYD จินหลง รังสิต`
    }, {
      property: "og:description",
...
const $$splitComponentImporter$c = () => import("./byd-promotion-BBF4_1Dk.mjs");
const Route$c = createFileRoute("/byd-promotion")({
  head: () => ({
    meta: [{
      title: "โปรโมชั่น BYD ล่าสุดเดือนนี้ 2026 | บีวายดี จินหลง มอเตอร์ สาขารังสิต"
    }, {
      name: "description",
      content: "รวมโปรโมชั่น BYD ล่าสุด ดอกเบี้ย 0% ฟรีประกันชั้น 1 ฟรีฟิล์ม ของแถมพิเศษ พร้อมข้อเสนอเฉพาะลูกค้า BYD จินหลง รังสิต"
    }, {
      property: "og:title",
      content: "โปรโมชั่น BYD | BYD จินหลง รังสิต"
    }, {
      property: "og:description",
...
const SLUG$4 = "byd-m6";
const $$splitComponentImporter$b = () => import("./byd-m6-p8wcvVPT.mjs");
const Route$b = createFileRoute("/byd-m6")({
  head: () => {
    ...
    if (!model2) {
      return {
        meta: [{
          title: "BYD M6 | บีวายดี จินหลง มอเตอร์ สาขารังสิต"
        }, {
          name: "description",
          ...
          property: "og:title",
          content: "BYD M6 | BYD จินหลง รังสิต"
        }, {
          property: "og:description",
    ...
    return {
      meta: [{
        ...
        property: "og:title",
        content: `${model2.name} | BYD จินหลง รังสิต`
      }, {
        property: "og:description",
...
const $$splitComponentImporter$a = () => import("./byd-installment-DKUktuCM.mjs");
...
const $$splitComponentImporter$9 = () => import("./byd-dolphin-a7yc_vQI.mjs");
const model$3 = getModel(SLUG$3);
const Route$9 = createFileRoute("/byd-dolphin")({
  head: () => ({
    meta: [{
      title: `${model$3.name} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
    }, {
      name: "description",
      ...
      property: "og:title",
      content: `${model$3.name} | BYD จินหลง รังสิต`
    }, {
      property: "og:description",
...
const $$splitComponentImporter$8 = () => import("./byd-atto3-B8dvbVk5.mjs");
const model$2 = getModel(SLUG$2);
const Route$8 = createFileRoute("/byd-atto3")({
  head: () => ({
    meta: [{
      title: `${model$2.name} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
    }, {
      name: "description",
      ...
      property: "og:title",
      content: `${model$2.name} | BYD จินหลง รังสิต`
    }, {
      property: "og:description",
...
const $$splitComponentImporter$7 = () => import("./byd-atto2-Ce0jSp8e.mjs");
const model$1 = getModel(SLUG$1);
const Route$7 = createFileRoute("/byd-atto2")({
  head: () => ({
    meta: [{
      title: `${model$1.name} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
    }, {
      name: "description",
      ...
      property: "og:title",
      content: `${model$1.name} | BYD จินหลง รังสิต`
    }, {
      property: "og:description",
...
const $$splitComponentImporter$6 = () => import("./byd-atto1-Dn_gflVZ.mjs");
const model = getModel(SLUG);
const Route$6 = createFileRoute("/byd-atto1")({
  head: () => ({
    meta: [{
      title: `${model.name} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
    }, {
      name: "description",
      ...
      property: "og:title",
      content: `${model.name} | BYD จินหลง รังสิต`
    }, {
      property: "og:description",
...
const $$splitComponentImporter$5 = () => import("../_slug-VZ7qmgaH.mjs");
const Route$5 = createFileRoute("/$slug")({
  ...
  head: ({
    ...
    if (!post) {
      return {
        meta: [{
          title: "Article not found | บีวายดี จินหลง มอเตอร์ สาขารังสิต"
        }]
      };
    }
    return {
      meta: [{
        title: `${post.title} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
      }, {
        name: "description",
...
const $$splitComponentImporter$4 = () => import("./index-BJlKfklU.mjs");
...
const Route$4 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      title: "บีวายดี จินหลง มอเตอร์ สาขารังสิต | โชว์รูมและศูนย์บริการมาตรฐาน BYD บีวายดี จินหลง มอเตอร์"
    }, {
      name: "description",
      ...
      property: "og:title",
      content: "BYD จินหลง มอเตอร์ รังสิต — รถไฟฟ้า BYD กรุงเทพ"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$3 = () => import("./index-DizD_kBx.mjs");
...
const Route$3 = createFileRoute("/blog/")({
  ...
  head: () => ({
    meta: [{
      title: "บทความรถไฟฟ้า BYD & ความรู้ EV | บีวายดี จินหลง มอเตอร์ สาขารังสิต"
    }, {
      name: "description",
      content: "บทความ รีวิว เปรียบเทียบ และคำแนะนำเกี่ยวกับรถยนต์ไฟฟ้า BYD และเทคโนโลยี EV ในประเทศไทย"
    }, {
      property: "og:title",
      content: "บทความ BYD | BYD จินหลง รังสิต"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$2 = () => import("../_slug-DUBH8j6F.mjs");
const Route$2 = createFileRoute("/blog/$slug")({
  head: ({
    ...
    return {
      meta: [{
        title: `${a.title} | บีวายดี จินหลง มอเตอร์ สาขารังสิต`
      }, {
        name: "description",
        content: a.excerpt
      }, {
