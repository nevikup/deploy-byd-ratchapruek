...
import { M as MODELS, g as getInstallmentModel, a as getModel, I as INSTALLMENT_MODELS } from "./models-5WlIsOUj.mjs";
import { c as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { c as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-_cTX7XOg.mjs";
...
import "node:https";
import "node:http2";
const appCss = "/assets/styles-D5zlkuax.css";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm leading-relaxed", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "ฝ่ายขายเปิดทุกวัน 08.30 น. - 18.00 น.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "ฝ่ายบริการเปิด จันทร์ - เสาร์ 08.30 น. - 17.30 น."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
const $$splitComponentImporter$n = () => import("./test-drive-byd-VP7frMc8.mjs");
const Route$o = createFileRoute("/test-drive-byd")({
  head: () => ({
    meta: [{
    ...
    handlers: {
      GET: async () => {
        ...
        const xml = [
          ...
          ...paths.map((path) => `  <url><loc>${SITE_URL}${path}</loc><changefreq>weekly</changefreq></url>`),
          `</urlset>`
        ].join("\n");
...
const $$splitComponentImporter$m = () => import("./models-C9N6YtFY.mjs");
const Route$m = createFileRoute("/models")({
  pendingMs: 150,
...
const $$splitComponentImporter$l = () => import("./contact-D5iK2skM.mjs");
...
const $$splitComponentImporter$k = () => import("./byd-sealion7-V01EiR83.mjs");
const model$8 = getModel(SLUG$9);
const Route$k = createFileRoute("/byd-sealion7")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$j = () => import("./byd-sealion6dmi-DEHEFJME.mjs");
const Route$j = createFileRoute("/byd-sealion6dmi")({
  head: () => {
...
const $$splitComponentImporter$i = () => import("./byd-sealion5dmi-DO0-uu11.mjs");
const model$7 = getModel(SLUG$8);
const Route$i = createFileRoute("/byd-sealion5dmi")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$h = () => import("./byd-sealion-6-dm-i-BTU5dmpx.mjs");
const Route$h = createFileRoute("/byd-sealion-6-dm-i")({
  beforeLoad: () => {
    throw redirect({
      to: "/byd-sealion6dmi",
      statusCode: 301
...
const $$splitComponentImporter$g = () => import("./byd-seal6-EaGAI-L8.mjs");
const model$6 = getModel(SLUG$7);
const Route$g = createFileRoute("/byd-seal6")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$f = () => import("./byd-seal5dmi-DHC5SRe9.mjs");
const model$5 = getInstallmentModel(SLUG$6);
const Route$f = createFileRoute("/byd-seal5dmi")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$e = () => import("./byd-seal-Zu7OxfQK.mjs");
const model$4 = getModel(SLUG$5);
const Route$e = createFileRoute("/byd-seal")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$d = () => import("./byd-promotion-BSmPO-Wd.mjs");
const Route$d = createFileRoute("/byd-promotion")({
  head: () => ({
    meta: [{
...
const SLUG$4 = "byd-m6";
const $$splitComponentImporter$c = () => import("./byd-m6-CzDIHfWt.mjs");
const Route$c = createFileRoute("/byd-m6")({
  head: () => {
...
const $$splitComponentImporter$b = () => import("./byd-installment-C-_V91AD.mjs");
...
const Route$b = createFileRoute("/byd-installment")({
  pendingMs: 150,
...
const $$splitComponentImporter$a = () => import("./byd-dolphin-D5c_xn98.mjs");
const model$3 = getModel(SLUG$3);
const Route$a = createFileRoute("/byd-dolphin")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$9 = () => import("./byd-atto3-50Amc0Fg.mjs");
const model$2 = getModel(SLUG$2);
const Route$9 = createFileRoute("/byd-atto3")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$8 = () => import("./byd-atto2-OfOox-Uq.mjs");
const model$1 = getModel(SLUG$1);
const Route$8 = createFileRoute("/byd-atto2")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./byd-atto1-C7SW7FRS.mjs");
const model = getModel(SLUG);
const Route$7 = createFileRoute("/byd-atto1")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$6 = () => import("../_slug-Bo4J7bDg.mjs");
const Route$6 = createFileRoute("/$slug")({
  pendingMs: 120,
...
const $$splitComponentImporter$5 = () => import("./index-CK7A1kTY.mjs");
reactExports.lazy(() => import("./InstallmentCalculator-BRrRV0rG.mjs").then((module) => ({
...
const $$splitComponentImporter$4 = () => import("./index-CI70CEhK.mjs");
...
const $$splitComponentImporter$3 = () => import("./byd-atto3-BTU5dmpx.mjs");
const Route$3 = createFileRoute("/tag/byd-atto3")({
  beforeLoad: () => {
    throw redirect({
      to: "/byd-atto3",
      statusCode: 301
...
const $$splitComponentImporter$2 = () => import("../_slug-CnH9FDhI.mjs");
...
const TestDriveBydRoute = Route$o.update({
  id: "/test-drive-byd",
  path: "/test-drive-byd",
...
const ModelsRoute = Route$m.update({
  id: "/models",
  path: "/models",
  getParentRoute: () => Route$p
});
...
const BydSealion7Route = Route$k.update({
  id: "/byd-sealion7",
  path: "/byd-sealion7",
  getParentRoute: () => Route$p
});
const BydSealion6dmiRoute = Route$j.update({
  id: "/byd-sealion6dmi",
  path: "/byd-sealion6dmi",
  getParentRoute: () => Route$p
});
const BydSealion5dmiRoute = Route$i.update({
  id: "/byd-sealion5dmi",
...
const BydSeal6Route = Route$g.update({
  id: "/byd-seal6",
  path: "/byd-seal6",
  getParentRoute: () => Route$p
});
const BydSeal5dmiRoute = Route$f.update({
  id: "/byd-seal5dmi",
  path: "/byd-seal5dmi",
  getParentRoute: () => Route$p
});
const BydSealRoute = Route$e.update({
  id: "/byd-seal",
  path: "/byd-seal",
  getParentRoute: () => Route$p
});
const BydPromotionRoute = Route$d.update({
  id: "/byd-promotion",
  path: "/byd-promotion",
  getParentRoute: () => Route$p
});
const BydM6Route = Route$c.update({
  id: "/byd-m6",
  path: "/byd-m6",
  getParentRoute: () => Route$p
});
const BydInstallmentRoute = Route$b.update({
  id: "/byd-installment",
  path: "/byd-installment",
  getParentRoute: () => Route$p
});
const BydDolphinRoute = Route$a.update({
  id: "/byd-dolphin",
  path: "/byd-dolphin",
  getParentRoute: () => Route$p
});
const BydAtto3Route = Route$9.update({
  id: "/byd-atto3",
  path: "/byd-atto3",
  getParentRoute: () => Route$p
});
const BydAtto2Route = Route$8.update({
  id: "/byd-atto2",
  path: "/byd-atto2",
  getParentRoute: () => Route$p
});
const BydAtto1Route = Route$7.update({
  id: "/byd-atto1",
  path: "/byd-atto1",
  getParentRoute: () => Route$p
});
const SlugRoute = Route$6.update({
  id: "/$slug",
  path: "/$slug",
  getParentRoute: () => Route$p
});
...
const TagBydAtto3Route = Route$3.update({
  id: "/tag/byd-atto3",
  path: "/tag/byd-atto3",
  getParentRoute: () => Route$p
});
