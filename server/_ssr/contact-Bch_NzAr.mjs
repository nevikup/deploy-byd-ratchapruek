...
import { P as PageShell, c as createSsrRpc } from "./router-DoZbT7Lo.mjs";
import { c as createServerFn } from "./server-CnDuuMea.mjs";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription } from "./dialog-CQAcLzCx.mjs";
...
const BRANCHES = [{
  name: "BYD RANGSIT",
  title: "บีวายดี จินหลง มอเตอร์ สาขารังสิต",
  phones: ["02-997-1133", "084-201-8833", "090-198-2056 (ติดต่อฝ่ายบริการ SA)", "095-204-3998 (ติดต่อฝ่ายทะเบียน)", "099-315-5853 (ติดต่อฝ่ายอะไหล่)"],
  hours: "เปิดทุกวัน 08:30-18:00 น.",
  address: "93 ถ.รังสิต-นครนายก ต.ประชาธิปัตย์ อ.ธัญบุรี จ.ปทุมธานี",
  mapUrl: "https://www.google.com/maps/place/%E0%B8%9A%E0%B8%B5%E0%B8%A7%E0%B8%B2%E0%B8%A2%E0%B8%94%E0%B8%B5+%E0%B8%88%E0%B8%B4%E0%B8%99%E0%B8%AB%E0%B8%A5%E0%B8%87+%E0%B8%A3%E0%B8%B1%E0%B8%87%E0%B8%AA%E0%B8%B4%E0%B8%95/@13.9331858,100.605646,12z/data=!4m6!3m5!1s0x311d7ffd158b26d9:0xe829d133c0c74e14!8m2!3d13.9864925!4d100.6245157!16s%2Fg%2F11bw5zpgq7?authuser=0&entry=ttu&g_ep=EgoyMDI2MDYyOS4wIKXMDSoASAFQAw%3D%3D",
  position: {
    lat: 13.9864925,
    lng: 100.6245157
  },
  facebook: "https://www.facebook.com/BYDjinlongRangsit",
  line: "https://line.me/R/ti/p/@498gsgno",
  tiktok: "https://www.tiktok.com/@bydrangsit",
  instagram: "https://www.instagram.com/bydrangsit",
  threads: "https://www.threads.com/@bydrangsit",
  youtube: "https://www.youtube.com/@bydrangsit",
  x: "https://twitter.com/bydrangsit"
}];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden border-b border-border", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-28 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-normal animate-fade-in-up leading-[1.05]", children: [
          "ติดต่อ ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "BYD จินหลง รังสิต" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 max-w-xl text-base sm:text-lg text-muted-foreground leading-relaxed animate-fade-in-up", children: "รวมข้อมูลโชว์รูมและศูนย์บริการสาขารังสิต พร้อมแผนที่และเส้นทางนำทางในหน้าเดียว" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16", id: "branches", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 mb-10 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: "แผนที่บีวายดี จินหลง มอเตอร์ สาขารังสิต" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-muted-foreground max-w-2xl mx-auto", children: "ดูตำแหน่งสาขารังสิตและคลิกเพื่อนำทางได้ทันที" })
      ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: BRANCHES[0].line, target: "_blank", rel: "noreferrer", className: "flex items-center gap-4 glass rounded-xl p-4 border border-border hover:border-primary/40 transition", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold", children: "@498gsgno" })
            ] })
          ] })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 max-w-4xl space-y-4 text-muted-foreground leading-relaxed", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-foreground", children: "โชว์รูมและศูนย์บริการ BYD จินหลง มอเตอร์ สาขารังสิต" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "เราพร้อมให้บริการที่สาขารังสิต เพื่อให้ลูกค้าเข้าถึงบริการได้สะดวกมากยิ่งขึ้น" }),
