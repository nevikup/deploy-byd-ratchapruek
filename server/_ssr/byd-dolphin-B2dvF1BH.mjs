...
import { l as SLUG$3, P as PageShell, k as heroBanner$1 } from "./router-4Wq99WH9.mjs";
...
import { a as getModel, c as calcInstallment, f as formatBaht, k as colorWhite$5 } from "./models-0Rvkj58o.mjs";
...
const imgEPlatform = "/assets/e-platform-C6BzzTq4.webp";
const imgV2L = "/assets/v2l-PzmbGVg_.webp";
const extSurge = "/assets/surge-BE6iafWF.webp";
const extLedTail = "/assets/led-tail-light-D7Xvm_sf.webp";
const extNfc = "/assets/nfc-7R0iKItD.webp";
const extWheel = "/assets/alloy-wheel-BXosDHW6.webp";
const intGlassRoof = "/assets/glass-roof-DWkCiaI5.webp";
const intDesign = "/assets/dolphin-design-DQ-4FdFR.webp";
const intDriveMode = "/assets/drive-mode-AeMnS6vQ.webp";
const intWireless = "/assets/wireless-charging-BDVUcfNv.webp";
const TRIMS = [
...
const EXTERIOR_GALLERY = [
  { img: extSurge, label: "ดีไซน์ Exterior Surge", desc: "รูปทรงแอโรไดนามิกที่ได้แรงบันดาลใจจากโลมา ทั้งสนุกสนานและเปี่ยมด้วยประโยชน์ใช้สอย" },
  { img: extLedTail, label: "ไฟท้าย LED Geometric Polyline", desc: "ไฟท้าย LED ลวดลายเรขาคณิตที่โดดเด่น สร้างเอกลักษณ์ให้ด้านท้ายรถ" },
  { img: extNfc, label: "การ์ด NFC / กุญแจแบบไร้กุญแจ", desc: "กุญแจการ์ด NFC ที่สะดวก พร้อมระบบ Keyless Entry และ Keyless Start" },
  { img: extWheel, label: "ล้ออัลลอยสไตล์สปอร์ต", desc: "ล้ออัลลอยทูโทนดีไซน์โดดเด่น ลงตัวทั้งสไตล์และประสิทธิภาพ" }
];
const INTERIOR_GALLERY = [
  { img: intGlassRoof, label: "หลังคากระจกพาโนรามิกไฟฟ้า", desc: "หลังคากระจกพาโนรามิกขนาดใหญ่ครอบคลุมห้องโดยสารทั้งห้อง (รุ่น Extended)" },
  { img: intDesign, label: "ดีไซน์ Dolphin", desc: "รายละเอียดภายในและมือจับประตูที่ได้แรงบันดาลใจจากมหาสมุทร" },
  { img: intDriveMode, label: "โหมดการขับขี่แห่งนวัตกรรม", desc: "คันเกียร์ไฟฟ้าแบบสัมผัส พร้อมชุดควบคุมดีไซน์มีสไตล์" },
  { img: intWireless, label: "แท่นชาร์จโทรศัพท์ไร้สาย", desc: "แท่นชาร์จไร้สายสำหรับเติมพลังให้อุปกรณ์ได้อย่างสะดวก (รุ่น Extended)" }
];
const DIMENSIONS = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 border-y border-border bg-surface/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: "เลือกชุดรุ่นที่ใช่" })
      ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-y border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: imgBladeBattery, imgAlt: "BYD Blade Battery", reverse: false, title: "BLADE BATTERY", subtitle: "Safety Technology", body: "เทคโนโลยีแบตเตอรี่ความปลอดภัยสูง สุดยอดนวัตกรรมแบตเตอรี่ระดับโลกจาก BYD ชาร์จไวไปได้ไกลกว่า ขับขี่ได้อย่างมั่นใจในทุกเส้นทาง" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: imgEPlatform, imgAlt: "e-Platform 3.0", reverse: true, title: "e-PLATFORM 3.0", subtitle: "Next-Gen EV Architecture", body: "แพลตฟอร์มเอกสิทธิ์เฉพาะจาก BYD เพื่อความสมดุลที่ช่วยยกระดับการขับขี่ไปอีกขั้น ด้วยมอเตอร์แบบซิงโครนัสชนิดแม่เหล็กถาวรให้ความนุ่มนวลในการขับขี่ อัตราเร่งที่แรงดั่งใจ" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: imgV2L, imgAlt: "VtoL Vehicle to Load", reverse: false, title: "VtoL (VEHICLE TO LOAD)", subtitle: "Smart Energy", body: "รองรับทุกการเดินทางให้สะดวกสบายยิ่งขึ้น ด้วยระบบ VtoL การต่อไฟจากแบตเตอรี่รถยนต์กับเครื่องใช้ไฟฟ้า พร้อมรับทุกไลฟ์สไตล์" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ขนาดและน้ำหนัก", icon: Ruler, rows: dimensionsRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ระบบส่งกำลังและสมรรถนะ", icon: Gauge, rows: performanceRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "พลังงานใหม่", icon: Battery, rows: chargingRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "อุปกรณ์มาตรฐานภายนอก", icon: Sun, rows: exteriorRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "อุปกรณ์มาตรฐานภายใน", icon: Sparkles, rows: interiorRows }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ระบบมัลติมีเดียและความสะดวกสบาย", icon: CircuitBoard, rows: multimediaRows }) })
      ] })
    ] }) }),
