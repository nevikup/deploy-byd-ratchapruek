...
import { M as MODELS } from "./models-5WlIsOUj.mjs";
import { q as cn, c as createSsrRpc } from "./router-dmoIe8m5.mjs";
import { c as createServerFn } from "./server-ePh921h1.mjs";
import { S as Slot } from "../_libs/radix-ui__react-slot.mjs";
import { c as cva } from "../_libs/class-variance-authority.mjs";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription } from "./dialog-BTclR7Ig.mjs";
...
function getAppointmentDateError(value) {
  ...
  if (selectedDate < minDate) {
    return "วันที่นัดหมายต้องไม่ย้อนหลัง";
  }
  if (selectedDate > maxDate) {
    return "วันที่นัดหมายเลือกได้ไม่เกิน 1 เดือนจากวันนี้";
  }
  return null;
}
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "form",
      {
        onSubmit: async (e) => {
          ...
          const appointmentDateError = getAppointmentDateError(form.date);
