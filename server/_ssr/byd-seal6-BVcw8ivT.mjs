...
import { b as SLUG$7, P as PageShell } from "./router-4Wq99WH9.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, e as colorHorizonWhite } from "./models-0Rvkj58o.mjs";
...
const storyInfotainmentImage = "/assets/infotainment-HZ6eJSVS.webp";
const exteriorLed = "/assets/seal6-exterior-led-CiTVfhMW.webp";
...
const exteriorAlloyWheel = "/assets/seal6-exterior-alloyWheel-BglN0hWZ.webp";
const interiorInstrumentDisplay = "/assets/instrumentDisplay-gM1ZC40e.jpeg";
const interiorMultimediaTouchScreen = "/assets/multimediaTouchScreen-C6FX2zZe.webp";
...
function BydSeal6Brochure({ model }) {
  ...
  const storyContent = storySections;
  const dimensionRows = dimensionsRows;
  const powertrainContent = powertrainRows;
  const chargingContent = chargingRows;
  const safetyContent = safetyRows;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative w-full overflow-hidden bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", style: { maxHeight: "80vh", aspectRatio: "16/9" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, src: VIDEO_URL, poster: heroBanner, controls: videoPlaying, playsInline: true, preload: "metadata", className: "h-full w-full object-cover", onPlay: () => setVideoPlaying(true) }),
      !videoPlaying && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex cursor-pointer flex-col items-center justify-center", style: { background: "rgba(0,0,0,0.38)" }, onClick: handlePlayVideo, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-20 w-20 items-center justify-center rounded-full transition-all hover:scale-105", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "overflow-hidden border-y border-border", children: storyContent.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: item.image, imgAlt: item.title, reverse: index % 2 === 1, title: item.title, subtitle: item.subtitle, body: item.body }, item.title)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "ขนาดและน้ำหนัก", icon: Gauge, rows: toSpecRows(dimensionRows) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "ระบบส่งกำลังและสมรรถนะ", icon: Zap, rows: toSpecRows(powertrainContent) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "พลังงานใหม่", icon: Battery, rows: toSpecRows(chargingContent) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: "ระบบความปลอดภัย", icon: ShieldCheck, rows: toSpecRows(safetyContent) }) })
      ] })
    ] }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass overflow-hidden rounded-2xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/60", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "w-1/2 px-6 py-3 text-left font-medium", children: "รายการ" }),
