...
import { o as SLUG$1, P as PageShell } from "./router-4Wq99WH9.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, n as colorSurgeWhite } from "./models-0Rvkj58o.mjs";
...
const exteriorDragonFace = "/assets/exterior-dragonFace-YSeU5Lch.webp";
const exteriorHeadLight = "/assets/exterior-headLight-G16PRvG4.webp";
const exteriorTailLight = "/assets/exterior-tailLight-C830XdEZ.webp";
const exteriorAlloyWheels = "/assets/exterior-alloyWheels-CVvJnGwL.webp";
const exteriorDigitalKey = "/assets/exterior-digitalKey-Ijdje1-D.webp";
const exteriorVtoL = "/assets/exterior-VtoL-8S-QZPFe.webp";
const interiorLcdDigital = "/assets/interior-lcdDigital-CHdEzFxS.webp";
const interiorMultimediaScreen = "/assets/interior-multimediaScreen-JMFEPMSA.webp";
const interiorFrontSeats = "/assets/interior-frontSeats-DP96CfkU.webp";
const interiorRearSeats = "/assets/interior-rearSeats-DtkMxPoO.webp";
const interiorPassengerSeats = "/assets/interior-passengerSeats-Bp0sEuiY.webp";
const interiorRearAirComfort = "/assets/interior-rearAirComfort-Dm16hhPl.webp";
...
const COLORS = [
  { name: "สีเขียว Minimal Green", hex: "#8AA48E", border: "#8AA48E", img: colorMinimalGreen, note: "Dynamic · Premium" },
  { name: "สีเทา Harbour Grey", hex: "#6A6D73", border: "#6A6D73", img: colorHarbourGrey, note: "Dynamic · Premium" },
  { name: "สีขาว Surge White", hex: "#F3F3F0", border: "#DADADA", img: colorSurgeWhite, note: "Dynamic · Premium" },
  { name: "สีดำ Quantum Black", hex: "#0E0F11", border: "#444", img: colorQuantumBlack, note: "Dynamic · Premium" }
];
const EXTERIOR_GALLERY = [
  { img: exteriorDragonFace, label: "Dragon Face", desc: "กระจังหน้าดีไซน์ Dragon Face เอกลักษณ์ของ ATTO 2" },
  { img: exteriorHeadLight, label: "ไฟหน้า Full LED", desc: "ไฟหน้า Full LED พร้อมไฟส่องสว่างสำหรับการขับขี่ในเวลากลางวัน" },
  { img: exteriorTailLight, label: "ไฟท้าย Möbius Ring", desc: "ไฟท้าย LED แบบต่อเนื่อง โดดเด่นชัดเจนในยามค่ำคืน" },
  { img: exteriorAlloyWheels, label: "ล้ออัลลอย 17 นิ้ว", desc: "ล้ออัลลอย 17 นิ้ว ที่ลงตัวทั้งดีไซน์และสมรรถนะ" },
  { img: exteriorDigitalKey, label: "กุญแจดิจิทัล", desc: "ปลดล็อกและสตาร์ทรถผ่านสมาร์ตโฟนด้วยกุญแจดิจิทัล" },
  { img: exteriorVtoL, label: "V2L จ่ายไฟจากรถ", desc: "ระบบ Vehicle-to-Load จ่ายไฟฟ้าจากแบตเตอรี่รถให้อุปกรณ์ภายนอก" }
];
const INTERIOR_GALLERY = [
  { img: interiorLcdDigital, label: "หน้าจอผู้ขับขี่ 8.8 นิ้ว", desc: "หน้าจอแสดงข้อมูลผู้ขับขี่ 8.8 นิ้ว อ่านข้อมูลสำคัญได้ชัดเจนในพริบตา" },
  { img: interiorMultimediaScreen, label: "จอสัมผัส 12.8 นิ้ว", desc: "หน้าจอกลางขนาดใหญ่พร้อมการเชื่อมต่อครบครัน" },
  { img: interiorFrontSeats, label: "เบาะหน้าระบายอากาศ", desc: "เบาะหน้าปรับไฟฟ้าพร้อมระบบระบายอากาศในรุ่น Premium" },
  { img: interiorRearSeats, label: "ห้องโดยสารท้ายยืดหยุ่น", desc: "เบาะหลังพับแยก 60:40 เพิ่มพื้นที่เก็บสัมภาระได้สูงสุด 1,320 ลิตร" },
  { img: interiorPassengerSeats, label: "เบาะผู้โดยสารด้านหน้า", desc: "เบาะผู้โดยสารด้านหน้าปรับได้เพื่อความสะดวกสบายตลอดการเดินทาง" },
  { img: interiorRearAirComfort, label: "ช่องแอร์ด้านหลัง", desc: "ช่องปรับอากาศด้านหลังเพิ่มความเย็นสบายให้ผู้โดยสารทุกที่นั่ง" }
];
const DIMENSIONS = [
  { label: "ความยาว (มิลลิเมตร)", values: ["4,310", "4,310"] },
  { label: "ความกว้าง (มิลลิเมตร)", values: ["1,830", "1,830"] },
  { label: "ความสูง (มิลลิเมตร)", values: ["1,675", "1,675"] },
  { label: "ระยะฐานล้อ (มิลลิเมตร)", values: ["2,620", "2,620"] },
  { label: "ความสูงใต้ท้องรถ (มิลลิเมตร)", values: ["170", "170"] },
  { label: "รัศมีวงเลี้ยวแคบสุด (เมตร)", values: ["5.25", "5.25"] },
  { label: "น้ำหนักรถเปล่า (กิโลกรัม)", values: ["1,555", "1,555"] },
  { label: "น้ำหนักรถรวมน้ำหนักบรรทุกสูงสุด (กิโลกรัม)", values: ["1,965", "1,965"] },
  { label: "ความจุพื้นที่เก็บสัมภาระ (ลิตร)", values: ["380 / 1,320", "380 / 1,320"] }
];
const PERFORMANCE = [
  ...
  { label: "แรงบิดสูงสุด (นิวตัน-เมตร)", values: ["290", "290"] },
  { label: "อัตราเร่ง 0-100 กิโลเมตร/ชั่วโมง (วินาที)", values: ["7.9", "7.9"] },
  { label: "ระยะทางวิ่งสูงสุดตามมาตรฐาน NEDC (กิโลเมตร)", values: ["410", "410"] },
  { label: "ระบบกันสะเทือนหน้า / หลัง", values: ["แม็คเฟอร์สันสตรัท / ทอร์ชันบีม", "แม็คเฟอร์สันสตรัท / ทอร์ชันบีม"] }
];
const CHARGING = [
  { label: "ประเภทแบตเตอรี่", values: ["BYD Blade Battery", "BYD Blade Battery"] },
  { label: "ความจุแบตเตอรี่ (กิโลวัตต์-ชั่วโมง)", values: ["51.13", "51.13"] },
  { label: "สายชาร์จแบบพกพา (Mode 2)", values: [true, true] },
  { label: "รองรับหัวชาร์จ AC Type 2 สูงสุด (กิโลวัตต์)", values: ["7", "7"] },
  { label: "รองรับหัวชาร์จ DC CCS2 สูงสุด (กิโลวัตต์)", values: ["82", "82"] },
  { label: "ระบบจ่ายไฟจากรถสู่อุปกรณ์ภายนอก (V2L)", values: [true, true] },
  { label: "ระบบเบรกพร้อมชาร์จพลังงานกลับ", values: [true, true] }
];
const MULTIMEDIA = [
  { label: "หน้าจอระบบมัลติมีเดีย", values: ["10.1 นิ้ว", "12.8 นิ้ว"] },
  { label: "ระบบลำโพง", values: ["4 ตำแหน่ง", "8 ตำแหน่ง"] },
  { label: "รองรับ Apple CarPlay / Android Auto แบบไร้สาย", values: [true, true] },
  { label: "ระบบสั่งงานด้วยเสียงภาษาไทย / อังกฤษ", values: [true, true] },
  { label: "ที่ชาร์จโทรศัพท์มือถือแบบไร้สาย", values: [false, true] },
  { label: "NFC Card / Digital Key", values: [true, true] },
  { label: "รองรับการอัปเดตซอฟต์แวร์ OTA", values: [true, true] }
];
const SAFETY = [
  { label: "ถุงลมนิรภัยคู่หน้า", values: [true, true] },
  { label: "กล้องมองภาพรอบคัน 360 องศา", values: [false, true] },
  { label: "เซนเซอร์ช่วยจอดด้านหน้า", values: [false, true] },
  { label: "เซนเซอร์ช่วยจอดด้านหลัง", values: [true, true] },
  { label: "ระบบเตือนออกนอกเลน / ระบบเบรกฉุกเฉินอัตโนมัติ (LDW / AEB)", values: [true, true] },
  { label: "BSD / RCTA / RCTB / DOW", values: [false, true] },
  { label: "ระบบควบคุมความเร็วอัตโนมัติแบบแปรผัน / ระบบช่วยขับอัจฉริยะ (ACC / ICC)", values: [false, true] },
  { label: "ระบบจดจำป้ายจราจร / ระบบช่วยควบคุมความเร็วอัจฉริยะ (TSR / ISLC)", values: [false, true] },
...
function BydAtto2Brochure({ model }) {
  ...
  const chargingRows = CHARGING;
  const safetyRows = SAFETY;
  const multimediaRows = MULTIMEDIA;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative w-full min-h-[88vh] flex items-end overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full px-6 sm:px-12 lg:px-20 pb-16 pt-32", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `mt-3 text-xl sm:text-2xl text-muted-foreground font-light ${"tracking-normal leading-snug"}`, children: "พร้อมไปในทุกเส้นทางของคุณ" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          { label: "ระยะทางวิ่ง", val: "410 km" },
          { label: "0-100 km/h", val: "7.9 วินาที" },
          { label: "กำลังสูงสุด", val: "130 kW" },
          { label: "แรงบิดสูงสุด", val: "290 Nm" },
          { label: "แบตเตอรี่", val: "51.13 kWh" }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 border-y border-border bg-surface/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: "รุ่นย่อย" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-3xl p-6 sm:p-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4", children: [
          { label: "0-100 km/h", val: `${currentTrim.accel} ${"วินาที"}` },
          { label: "ระยะทาง NEDC", val: `${currentTrim.range} km` },
          { label: "กำลังสูงสุด", val: currentTrim.power },
          { label: "แรงบิดสูงสุด", val: currentTrim.torque },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative w-full bg-black overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", style: { maxHeight: "80vh", aspectRatio: "16/9" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, src: VIDEO_URL, poster: heroBanner, controls: videoPlaying, playsInline: true, className: "w-full h-full object-cover", onPlay: () => setVideoPlaying(true), style: { display: "block" } }),
      !videoPlaying && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center cursor-pointer", style: { background: "rgba(0,0,0,0.38)" }, onClick: handlePlayVideo, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-white text-lg font-semibold tracking-widest uppercase", children: "วิดีโอแนะนำ BYD ATTO 2" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-surface/40 border-y border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: "ดีไซน์" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row items-center gap-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { delay: 100, className: "flex flex-col gap-3 min-w-[240px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-widest text-muted-foreground mb-2", children: "สีภายนอก" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: "แกลเลอรี" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: "ดีไซน์รอบคันพร้อมตอบโจทย์ทุกไลฟ์สไตล์" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-y border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: storyCompactSuvImage, imgAlt: "Compact SUV", reverse: false, title: "พร้อมไปในทุกเส้นทางของคุณ", subtitle: "คอมแพ็กต์ SUV ไฟฟ้า", body: "คอมแพ็กต์ SUV ไฟฟ้าที่ผสานดีไซน์โดดเด่น ความคล่องตัว และการใช้งานจริงในทุกวัน" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: storyDesignConceptImage, imgAlt: "Design Concept", reverse: true, title: "ดีไซน์ DRAGON FACE", subtitle: "ดีไซน์เอกลักษณ์", body: "เส้นสายภายนอกลื่นไหลแต่หนักแน่น สร้างบุคลิกชัดเจนจากทุกมุมมอง" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: storyEPlatformImage, imgAlt: "e-Platform and Blade Battery", reverse: false, title: "e-PLATFORM 3.0 + BLADE BATTERY", subtitle: "เทคโนโลยีหลัก", body: "ยกระดับสมรรถนะ ความปลอดภัย และประสิทธิภาพสำหรับรถ EV เจเนอเรชันใหม่" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: "ข้อมูลสเปก" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ขนาดและน้ำหนัก", icon: Users, rows: dimensionsRows, leftHeader: "Dynamic", rightHeader: "Premium" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "สมรรถนะ", icon: Gauge, rows: performanceRows, leftHeader: "Dynamic", rightHeader: "Premium" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "แบตเตอรี่และการชาร์จ", icon: Battery, rows: chargingRows, leftHeader: "Dynamic", rightHeader: "Premium" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ระบบความปลอดภัย", icon: ShieldCheck, rows: safetyRows, leftHeader: "Dynamic", rightHeader: "Premium" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ระบบมัลติมีเดียและความสะดวกสบาย", icon: CircuitBoard, rows: multimediaRows, leftHeader: "Dynamic", rightHeader: "Premium" }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "installment", className: "py-20 bg-surface/40 border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: "ไฟแนนซ์" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "test-drive", className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: "ทดลองขับ" }),
...
function SpecTable2({ title, icon: Icon, rows, leftHeader, rightHeader }) {
...
function Cell2({ value }) {
  if (value === true)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-5 w-5 text-primary mx-auto", "aria-label": "Included" });
  if (value === false)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "h-4 w-4 text-muted-foreground mx-auto", "aria-label": "Not included" });
