...
import { a as SLUG$8, P as PageShell } from "./router-DoZbT7Lo.mjs";
...
import { a as getModel, c as calcInstallment, f as formatBaht, d as colorWhite$1 } from "./models-B69ILCyc.mjs";
...
function BydSealion5DmiBrochure({ model }) {
  ...
  const vehicleSchema = {
    ...
    offers: {
      ...
      seller: { "@type": "AutoDealer", name: "BYD จินหลง รังสิต" }
    }
  };
