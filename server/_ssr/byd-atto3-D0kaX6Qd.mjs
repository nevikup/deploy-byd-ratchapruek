...
import { n as SLUG$2, P as PageShell, m as heroBanner$2 } from "./router-4Wq99WH9.mjs";
...
import { a as getModel, c as calcInstallment, f as formatBaht, l as colorWhite$4 } from "./models-0Rvkj58o.mjs";
...
const imgBladeBattery = "/assets/overview-img-01-DukI9NRZ.webp";
const imgEPlatform = "/assets/overview-img-02-CJoO-7lo.png";
const imgLifestyle = "/assets/new-atto3-description-3-Dpiba0tl.png";
const extImg01 = "/assets/exterior-img-01-Bqjm76VK.webp";
const extImg02 = "/assets/exterior-img-02-BT_wMaS4.webp";
const extImg03 = "/assets/exterior-img-03-2VFwPOxx.webp";
const extImg04 = "/assets/exterior-img-04-VxPN48nx.webp";
const extImg05 = "/assets/exterior-img-05-BaSLIQVc.webp";
const extImg06 = "/assets/exterior-img-06-C6_LZjQe.webp";
const intImg01 = "/assets/interior-img-01-DTJFakyc.webp";
const intImg02 = "/assets/interior-img-02-DYhshgDe.webp";
const intImg03 = "/assets/interior-img-03-DF1KJexN.webp";
const intImg04 = "/assets/interior-img-04-COdQyiE1.webp";
const intImg05 = "/assets/interior-img-05-G0HkBGlX.webp";
const intImg06 = "/assets/interior-img-06-CMtwmc9C.webp";
const TRIMS = [
...
const EXTERIOR_GALLERY = [
  { img: extImg01, label: "ไฟหน้า Crystal LED", desc: "ไฟหน้า LED คิ้วโครเมียมดีไซน์โดดเด่น รับกับไฟท้าย LED แนวกว้าง" },
  { img: extImg02, label: "เสา C ดีไซน์ Wave-Formed", desc: "เสา C ลวดลายคลื่นอันเป็นเอกลักษณ์ เพิ่มบุคลิกสปอร์ตให้กับตัวรถ" },
  { img: extImg03, label: "ล้ออัลลอยแอโรไดนามิก 18 นิ้ว", desc: "ล้ออัลลอยขนาด 18 นิ้ว ออกแบบเพื่อประสิทธิภาพด้านอากาศพลศาสตร์" },
  { img: extImg04, label: "เส้นสายภายนอกที่โดดเด่น", desc: "เส้นสายตัวถังที่ออกแบบอย่างทรงพลัง สร้างรูปลักษณ์ที่ดูมีพลัง" },
  { img: extImg05, label: "หลังคากระจกพาโนรามิก", desc: "หลังคากระจกพาโนรามิกช่วยเพิ่มแสงและความโปร่งให้กับห้องโดยสาร" },
  { img: extImg06, label: "รายละเอียดภายนอกที่ประณีต", desc: "รายละเอียดภายนอกที่ใส่ใจ ช่วยเติมเต็มดีไซน์ของ BYD ATTO 3" }
];
const INTERIOR_GALLERY = [
  { img: intImg01, label: "หลังคาซันรูฟพาโนรามิก", desc: "ซันรูฟพาโนรามิกไฟฟ้าแบบสัมผัสเดียว พร้อมระบบป้องกันการหนีบ" },
  { img: intImg02, label: "แผงประตู Red String", desc: "เส้นสายสีแดงบนแผงประตูที่ได้แรงบันดาลใจจากสายเครื่องดนตรี" },
  { img: intImg03, label: "พวงมาลัยมัลติฟังก์ชัน 3 ก้าน", desc: "พวงมาลัยมัลติฟังก์ชันสไตล์สปอร์ต ควบคุมการใช้งานได้อย่างสะดวก" },
  { img: intImg04, label: "คันเกียร์ไฟฟ้าแบบสัมผัส", desc: "ช่องแอร์ทรงดัมเบล พร้อมคันเกียร์ไฟฟ้าที่ควบคุมด้วยปลายนิ้ว" },
  { img: intImg05, label: "ความสบายภายในระดับพรีเมียม", desc: "ห้องโดยสารที่สะดวกสบาย พร้อมรายละเอียดที่ออกแบบมาเพื่อทุกการเดินทาง" },
  { img: intImg06, label: "เทคโนโลยีห้องโดยสารอัจฉริยะ", desc: "เทคโนโลยีที่ใช้งานง่ายและรายละเอียดที่ตอบโจทย์ ช่วยยกระดับประสบการณ์การขับขี่" }
];
const DIMENSIONS = [
...
function BydAtto3Brochure({ model }) {
  ...
  const exteriorRows = EXTERIOR_SPEC;
  const interiorRows = INTERIOR_SPEC;
  const lightingRows = LIGHTING;
  const multimediaRows = MULTIMEDIA;
  const comfortRows = COMFORT;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative w-full bg-black overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", style: { maxHeight: "80vh", aspectRatio: "16/9" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, src: "https://storage.googleapis.com/ram_asset_prd/models/new-atto3/new-atto3-video.mp4", poster: heroBanner$2, controls: videoPlaying, playsInline: true, className: "w-full h-full object-cover", onPlay: () => setVideoPlaying(true), style: { display: "block" } }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-y border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: imgBladeBattery, imgAlt: "BYD Blade Battery", reverse: false, title: "e-Platform 3.0", subtitle: "Next-Gen EV Architecture", body: "แพลตฟอร์มแห่งอนาคตที่ยกระดับการขับขี่รถยนต์พลังงานไฟฟ้าไปอีกขั้น ทั้งอัตราเร่ง ระยะทางการขับขี่ ความเร็วในการชาร์จ เกาะถนนเป็นเยี่ยม ตลอดจนความนุ่มนวลในทุกการขับขี่" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: imgEPlatform, imgAlt: "e-Platform 3.0", reverse: true, title: "BLADE BATTERY", subtitle: "Safety Technology", body: "นวัตกรรมใหม่ของเทคโนโลยีแบตเตอรี่ เอกสิทธิ์เฉพาะของ BYD ให้ความปลอดภัยสูงสุด มั่นใจได้ทุกการขับขี่" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: imgLifestyle, imgAlt: "INFOTAINMENT & LIFESTYLE", reverse: false, title: "INFOTAINMENT & LIFESTYLE", subtitle: "Smart Living", body: "ปลุกทุกความตื่นเต้นเร้าใจ ด้วยสุนทรียภาพของการขับขี่เหนือระดับตลอดการเดินทาง ด้วยฟังก์ชันการใช้งานที่ล้ำสมัย ตอบโจทย์ไลฟ์สไตล์คนเมืองอย่างแท้จริง" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ขนาดและมิติ", icon: Ruler, rows: dimensionsRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "สมรรถนะและช่วงล่าง", icon: Gauge, rows: performanceRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ระบบการชาร์จ", icon: Battery, rows: chargingRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ระบบความปลอดภัย", icon: ShieldCheck, rows: safetyRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "อุปกรณ์ภายนอก", icon: Sun, rows: exteriorRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "อุปกรณ์ภายใน", icon: Sparkles, rows: interiorRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ระบบไฟส่องสว่าง", icon: Zap, rows: lightingRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "มัลติมีเดียและอินโฟเทนเมนต์", icon: CircuitBoard, rows: multimediaRows }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: "ความสะดวกสบาย", icon: Users, rows: comfortRows }) })
      ] })
    ] }) }),
