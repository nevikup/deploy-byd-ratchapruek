...
import { j as SLUG$4, P as PageShell } from "./router-4Wq99WH9.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, j as crystalWhite } from "./models-0Rvkj58o.mjs";
...
const cabin = "/assets/two-tone-interior-cabin-BBpVg4sw.webp";
const ePlatform = "/assets/e-platform-Ddtz-RBu.webp";
const v2l = "/assets/v2l-1HNDWJOm.webp";
const frontGrille = "/assets/front-grille-CNZrCNHC.webp";
const ledHeadlights = "/assets/led-headlights-PW11pwDa.webp";
const chargingPort = "/assets/charging-port-B26LyUSI.webp";
const alloyWheels = "/assets/alloy-wheels-D0DnSfX-.webp";
const aluminumSideSill = "/assets/aluminum-side-sill-CY8G3b71.webp";
const steeringWheel = "/assets/multifunction-steering-wheel--CsZKIFF.webp";
const wirelessCharger = "/assets/wireless-charger-CDJtk-VH.webp";
const shifter = "/assets/finger-touched-electronic-shifter-CMh0Hsen.webp";
...
function BydM6Brochure({ model }) {
  ...
  const featureBlocks = FEATURE_BLOCKS;
  ...
  const faqs = [
    {
      q: "BYD M6 ราคาเท่าไร?",
      a: "Dynamic ราคา 769,900 บาท และ Extended ราคา 1,009,900 บาท"
    },
    {
      q: "BYD M6 วิ่งได้ไกลกี่กิโลเมตร?",
      a: "Dynamic วิ่งได้ 420 กม. และ Extended วิ่งได้ 530 กม. (NEDC)"
    },
    {
      q: "BYD M6 รองรับการชาร์จแบบไหน?",
      a: "รองรับ AC Type 2 7 kW และ DC CCS2 สูงสุด 85/115 kW ตามรุ่น"
    },
    {
      q: "BYD M6 นั่งได้กี่คน?",
      a: "รองรับผู้โดยสาร 6 ที่นั่ง แบบ 3 แถวจัดเรียง 2-2-2"
    },
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 border-y border-border bg-surface/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 80, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-3 mb-10", children: TRIMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setTrim(item.key), className: `rounded-full px-6 py-2.5 text-sm font-semibold transition-all duration-200 ${trim === item.key ? "gradient-accent text-white glow" : "glass border border-border hover:border-primary/40"}`, children: item.name }, item.key)) }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-surface/40 border-y border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row items-center gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { className: "flex-1 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full overflow-hidden rounded-2xl", style: { background: "linear-gradient(135deg, #0a0a0a 0%, #1a1a2e 100%)", aspectRatio: "16/9" }, children: COLORS.map((color, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: color.img, alt: color.name, className: "absolute inset-0 w-full h-full object-contain transition-opacity duration-500", style: { opacity: activeColor === index ? 1 : 0 } }, color.name)) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { delay: 100, className: "flex flex-col gap-3 min-w-[240px]", children: [
          ...
          COLORS.map((color, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setActiveColor(index), className: `flex items-center gap-4 rounded-xl px-4 py-3 transition-all duration-200 text-left ${activeColor === index ? "border border-primary/60 bg-primary/8" : "glass border border-transparent hover:border-border"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `h-9 w-9 rounded-full flex-shrink-0 transition-all ${activeColor === index ? "ring-2 ring-primary ring-offset-2 ring-offset-background" : ""}`, style: { background: color.hex, border: `2px solid ${color.border}` }, "aria-hidden": true }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-2 mb-8", children: ["exterior", "interior"].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setGalleryTab(tab), className: `rounded-full px-8 py-2.5 text-sm font-semibold capitalize transition-all ${galleryTab === tab ? "gradient-accent text-white glow" : "glass border border-border hover:border-primary/40"}`, children: tab === "exterior" ? "ภายนอก" : "ภายใน" }, tab)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full overflow-hidden rounded-2xl bg-surface", style: { aspectRatio: "16/9" }, children: [
        galleryItems.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.img, alt: item.label, className: "absolute inset-0 w-full h-full object-cover transition-opacity duration-500", style: { opacity: activeGallery === index ? 1 : 0 } }, item.label)),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 80, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3 mt-4", children: galleryItems.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setActiveGallery(index), className: `relative overflow-hidden rounded-xl transition-all ${activeGallery === index ? "ring-2 ring-primary opacity-100" : "opacity-55 hover:opacity-85"}`, style: { aspectRatio: "16/9" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.img, alt: item.label, className: "w-full h-full object-cover" }) }, `${item.label}-thumb`)) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-y border-border overflow-hidden", children: featureBlocks.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: item.img, imgAlt: item.imgAlt, title: item.title, subtitle: item.subtitle, body: item.body, reverse: index % 2 === 1 }, item.title)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
