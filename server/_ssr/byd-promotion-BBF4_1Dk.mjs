...
import { P as PageShell, i as PageHero, T as TEST_DRIVE_FORM_URL } from "./router-DoZbT7Lo.mjs";
...
function PromoPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "โปรโมชั่นเดือนนี้", title: "โปรโมชั่น BYD ล่าสุด", subtitle: "ข้อเสนอพิเศษสำหรับลูกค้า BYD จินหลง รังสิต เท่านั้น" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-surface/40 border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-4 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-muted-foreground", children: "ทีมงาน BYD จินหลง รังสิต พร้อมจัดข้อเสนอที่คุ้มค่าที่สุด" }),
